 ...
 * @author LVIS MACUA
 */
public class ViewProdutoComum extends javax.swing.JFrame {
    ...
    public ViewProdutoComum(ViewTelaPrincipalComum viewAnteriorComum){
        this();
    ...
    private void jbEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbEditarActionPerformed
        ...
        int codigoProduto=Integer.parseInt(String.valueOf(this.jtProdutos.getValueAt(linha, 0))); 
         ...
         this.jcbSexo.setSelectedItem(modeloProduto.getSexo());
            ...
            new ViewSelecionarProdutoComum(this).setVisible(true);
            habilitarDesabilitar(false);
        }
    ...
    private void jbExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbExcluirActionPerformed
        ...
        try {
         ...
         if(controllerProduto.excluirProdutoController(modeloProduto)){ 
             modeloProduto.setEstado("eliminado");
             this.setEnabled(false);
             new ViewDeletadoProdutoComum(this).setVisible(true);
             preencherTabelaProduto();
         }
            ...
            e.printStackTrace();
            this.setEnabled(false);
            new ViewErroExcluirProdutosComum(this).setVisible(true);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewProdutoComum.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewProdutoComum().setVisible(true);
            }
        });
    } 
    ...
    private void salvarDadosProdutos() { 
        ...
        if(this.jtfDescricao.getText().isEmpty() || this.jcbSexo.getSelectedItem().equals("") ||this.jtfCodigoBarras.getText().isEmpty() ||
             ...
             this.jtfValor.getText().equals(0)  ){ 
                 this.setEnabled(false);
                 new ViewPreencherTodosCamposProdutosComum(this).setVisible(true);
       ...
       // modeloProduto.setValor(100.25);
        ...
        if(controllerProduto.salvarProdutoController(modeloProduto)>0){ 
            this.setEnabled(false);
            new ViewSalvoProdutoComum(this).setVisible(true);
           preencherTabelaProduto();
            limparDados();
        }else{ 
            this.setEnabled(false);
            new ViewErroSalvarProdutoComum(this).setVisible(true);
        } 
        }
    ...
    private void editarDadosProdutos() {
        ...
        if(controllerProduto.editarProdutosController(modeloProduto)){ 
            this.setEnabled(false);
            new ViewEditarProdutoComum(this).setVisible(true);
           preencherTabelaProduto();
            limparDados();
        }else{ 
            this.setEnabled(false);
            new ViewErroEditarProdutoComum(this).setVisible(true);
        } 
