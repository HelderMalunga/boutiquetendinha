 ...
 * @author LVIS MACUA
 */
public class ViewProdutoDeletadoComum extends javax.swing.JFrame {
    ...
    private ViewProdutoDeletadoComum() {
        initComponents();
        setLocation(365,180);
    ...
    public ViewProdutoDeletadoComum(ViewTelaPrincipalComum viewAnteriorComum){
        this();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewProdutoDeletadoComum.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewProdutoDeletadoComum().setVisible(true);
            }
        });
    } 
